...
public class FaceVerifyUtil {
    ...
    /**
     * 引入依赖包 <dependency> <groupId>com.aliyun</groupId> <artifactId>facebody20191230</artifactId>
     * <version>${aliyun.facebody.version}</version> </dependency>
     */

    public static com.aliyun.facebody20191230.Client createClient(String accessKeyId, String accessKeySecret)
        throws Exception {
    ...
    public Boolean verifyFace(Float targetConfidence, String faceFilePath, String dataFilePath) throws Exception {
        ...
        com.aliyun.facebody20191230.Client client =
            FaceVerifyUtil.createClient(aliyunResource.getAccessKeyId(), aliyunResource.getAccessKeySecret());
        // 场景一，使用本地文件
        ...
        // 场景二，使用任意可访问的url
        // URL url = new
        // URL("https://viapi-test-bj.oss-cn-beijing.aliyuncs.com/viapi-3.0domepic/facebody/CompareFace/CompareFace-left1.png");
        com.aliyun.facebody20191230.models.CompareFaceAdvanceRequest compareFaceAdvanceRequest =
            new com.aliyun.facebody20191230.models.CompareFaceAdvanceRequest().setImageURLAObject(inputStreamA)
