...
public class Swagger2 {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("奇点社区·接口api")
            .contact(new Contact("奇点社区", "https://www.codeprobe.cn", "aingularity@codeprobe.cn"))
            .description("专为奇点社区·平台提供的api文档").version("1.0.1").termsOfServiceUrl("https://www.codeprobe.cn").build();
    }
}